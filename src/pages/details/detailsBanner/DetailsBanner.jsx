...
const DetailsBanner = ({ video, crew }) => {
  ...
  const writer=crew?.filter((i)=>i.job==='Writer' || i.job==='Story' || i.job==='Screenplay')
  return (
                ...
                <div className="content">
                  ...
                  <div className="right">
                    ...
                    {director?.length>0 && <div className="info">
                        ...
                        <span className="text">{director.map((d,i)=>(<span key={i}>
                            {d.name}
                            {director?.length-1 !==i && ', '}
                          </span>))}</span>
                      </div>
                    ...
                    {data?.created_by?.length>0 && <div className="info">
                        ...
                        <span className="text">{data?.created_by?.map((d,i)=>(<span key={i}>
                            {d.name}
